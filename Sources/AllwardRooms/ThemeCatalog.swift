...
public enum ThemeCatalog {
  public static let darkDefault = TerminalTheme(
    ...
    brights: colors(["#59616c", "#ef8585", "#8dcea4", "#e7c277", "#8ab7ea", "#c2a4e7", "#7ed0d5", "#f1f3f5"]),
  ...
  public static let lightDefault = TerminalTheme(
    ...
    brights: colors(["#666b73", "#c44f4f", "#438b5b", "#a87c2a", "#417db8", "#8f68b4", "#368e95", "#ffffff"]),
  ...
  public static let highContrastDark = TerminalTheme(
    ...
    brights: colors(["#707070", "#ff9494", "#9af0ae", "#ffe08e", "#9acbff", "#e3bcff", "#93f0f4", "#ffffff"]),
  ...
  public static let warmDark = TerminalTheme(
    ...
    brights: colors(["#675b52", "#ed8979", "#a7c282", "#ebbf78", "#91adca", "#c79ab7", "#89c0b7", "#eee5dc"]),
